...
public final class FacebookEvents {
     ...
     *
     * @param listener The callback object for notifying the application when auth events happen.
     */
     ...
     * logout occurs.
     *
     * @param listener The callback object for notifying the application when log out starts and finishes.
     */
     ...
     *
     * @param listener The callback object for notifying the application when post was published (or publishing was failed).
     */
